...
def initialize_vector_db(vector_db):
    """初始化向量数据库
...
def retrieve_by_document_id(document_id: str) -> List[Dict[str, Any]]:
    """根据文档ID检索文档
    ...
    try:
        results = _vector_db.get_by_document_id(document_id)
